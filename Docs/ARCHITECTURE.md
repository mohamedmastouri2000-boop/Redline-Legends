...
- Phase 1 Foundation — done (this document).
- Phase 2 Vehicle prototype — next: raycast suspension + slip-based tyre model (chosen over WheelCollider for
  arcade-realistic tuning control), transmission, chase/hood cameras, HUD, touch controls.
- Phase 3 Circuit slice, Phase 4 Drag slice, Phase 5 Garage/progression polish, Phase 6 Content (50 events,
  15 cars), Phase 7 Mobile optimisation.
